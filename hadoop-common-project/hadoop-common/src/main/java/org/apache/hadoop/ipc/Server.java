...
public abstract class Server {
    ...
    private class Listener extends Thread {
        ...
        private class Reader extends Thread {
            ...
            Reader(String name) throws IOException {
                ...
                // 创建 LinkedBlockingQueue 默认大小为 100
                ...
                while (running) {
                    ...
                    try {
                        ...
                        for (int i = size; i > 0; i--) {
                            ...
                            // Connection 封装了由 Listener 线程接受 Nio SocketChannel
                            // 往 Selector 注册该 SocketChannel 的 OP_READ 事件
        ...
        void doAccept(SelectionKey key) throws InterruptedException, IOException, OutOfMemoryError {
            ...
            // Listener 接受到一个 Nio Socket 连接请求
            while ((channel = server.accept()) != null) {
                ...
                // put Connection 到 Reader 线程的 pending, 并唤醒 Selector
    ...
    private class Responder extends Thread {
        ...
        void doRespond(RpcCall call) throws IOException {
            synchronized (call.connection.responseQueue) {
                ...
                // add response RpcCall
                call.connection.responseQueue.addLast(call);
                if (call.connection.responseQueue.size() == 1) {
                    // 如果 Response RpcCall 等于 1 立即发送
        ...
        public int readAndProcess() throws IOException, InterruptedException {
            while (!shouldClose()) { // stop if a fatal response has been sent.
                ...
                if (dataLengthBuffer.remaining() > 0) {
                    // 读取 SocketChannel 数据到 ByteBuffer 缓冲区用来校验
                ...
                // 真正读取 SocketChannel 的数据到 ByteBuffer
    ...
    protected Server(String bindAddress, int port,
        ...
        // 创建 Listener (线程), 里面启动 Nio ServerSocketChannel
    ...
    private class ConnectionManager {
        ...
        Connection register(SocketChannel channel, int ingressPort) {
            ...
            // 将 Listener 线程 accept Nio SocketChannel 封装为 Connection 对象
