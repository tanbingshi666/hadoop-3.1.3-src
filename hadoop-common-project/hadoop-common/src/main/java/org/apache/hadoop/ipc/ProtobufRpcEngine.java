...
public class ProtobufRpcEngine implements RpcEngine {
    ...
    private static class Invoker implements RpcInvocationHandler {
        ...
        private Invoker(Class<?> protocol, InetSocketAddress addr,
                ...
                throws IOException {
            // 往下追
            this(protocol, Client.ConnectionId.getConnectionId(addr, protocol, ticket, rpcTimeout, connectionRetryPolicy, conf),
                    conf, factory);
        ...
        private Invoker(Class<?> protocol, Client.ConnectionId connId,
            ...
            // 获取协议接口上 @ProtocolInfo 注解属性 protocolName 值
            this.protocolName = RPC.getProtocolName(protocol);
            // 获取协议接口上 @ProtocolInfo 注解属性 protocolVersion 值
        ...
        public Message invoke(Object proxy, final Method method, Object[] args)
            ...
            // 构建 Rpc Request 头部 Header 信息 (执行方法名称、协议接口名称、协议版本)
    ...
    public static class Server extends RPC.Server {
        ...
        static class ProtoBufRpcInvoker implements RpcInvoker {
            ...
            public Writable call(RPC.Server server, String connectionProtocolName,
                ...
                // 通过 Rpc Request 处理类以及执行方法名称得到具体的执行方法描述器
