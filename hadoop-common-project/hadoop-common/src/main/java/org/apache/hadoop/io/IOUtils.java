...
public class IOUtils {
    ...
    public static void copyBytes(InputStream in, OutputStream out, int buffSize)
        ...
        while (bytesRead >= 0) {
            ...
            // out = HdfsDataOutputStream extends FSDataOutputStream extends DataOutputStream extends FilterOutputStream implements DataOutput
            // 先调用 DataOutput.write() 接着调用 FilterOutputStream.write() 然后调用 DataOutputStream.write()
            // 在然后调用 FSDataOutputStream 入参 PositionCache.write() 本质调用 DFSOutputStream
