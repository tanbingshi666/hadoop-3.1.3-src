...
public class RPC {
    ...
    static synchronized RpcEngine getProtocolEngine(Class<?> protocol,
        ...
        if (engine == null) {
            ...
            // 初始化 org.apache.hadoop.ipc.ProtobufRpcEngine
     ...
     * @throws HadoopIllegalArgumentException if the proxy does not implement {@link Closeable} interface or
    ...
    public static class Builder {
        ...
        public Server build() throws IOException, HadoopIllegalArgumentException {
            ...
            // 初始化 org.apache.hadoop.ipc.ProtobufRpcEngine 从该类获取一个 Server
    ...
    public abstract static class Server extends org.apache.hadoop.ipc.Server {
        ...
        protected Server(String bindAddress, int port,
            ...
            // 调用父类 (里面创建 Listener、Reader、Response 三种线程)
