...
public class ActiveStandbyElector implements StatCallback, StringCallback {
    ...
    public ActiveStandbyElector(String zookeeperHostPorts,
        ...
        zkAuthInfo = authInfo;
        appClient = app;
        // parent znode = /hadoop-ha/${nameservice} 比如 /hadoop-ha/my_cluster
        znodeWorkingDir = parentZnodeName;
        // /hadoop-ha/my_cluster/ActiveStandbyElectorLock
        zkLockFilePath = znodeWorkingDir + "/" + LOCK_FILENAME;
        // /hadoop-ha/my_cluster/ActiveBreadCrumb
    ...
    public synchronized void processResult(int rc, String path, Object ctx,
        ...
        if (isSuccess(code)) {
            ...
            // 本地 NameNode 成为 active
            if (becomeActive()) {
                // 监控 ZK active 对应的 znode
                monitorActiveStatus();
            } else {
                // 重新加入选举
    ...
    synchronized void processWatchEvent(ZooKeeper zk, WatchedEvent event) {
        ...
        if (path != null) {
            ...
            // 一旦 lock 对应的 znode 发生变化 那么将会回调 processResult()
            return;
        }
    ...
    private void monitorActiveStatus() {
        ...
        // ZKFC 在 ZK 创建了 lock 对应的临时路径, 该对应的 NameNode 成为 Active
        monitorLockNodeAsync();
    }
    ...
    private void joinElectionInternal() {
        ...
        // 尝试创建 znode /hadoop-ha/my_cluster/ActiveStandbyElectorLock
        createLockNodeAsync();
    }
    ...
    private boolean becomeActive() {
        ...
        try {
            ...
            // 创建临时 znode (zkBreadCrumbPath) 或者更新 znode(zkBreadCrumbPath) data
    ...
    private void createLockNodeAsync() {
        // 创建 /hadoop-ha/my_cluster/ActiveStandbyElectorLock znode
        // 无论是否创建成功都会回调 WatcherWithClientRef process()
        // 往下追调用 ActiveStandbyElector processWatchEvent()
