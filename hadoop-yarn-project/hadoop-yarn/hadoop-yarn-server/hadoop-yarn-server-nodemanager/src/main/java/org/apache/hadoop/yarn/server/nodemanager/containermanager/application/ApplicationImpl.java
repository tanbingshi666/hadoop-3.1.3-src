...
public class ApplicationImpl implements Application {
    ...
    static class AppInitTransition implements
        ...
        public void transition(ApplicationImpl app, ApplicationEvent event) {
            ...
            // 调用 LogAggregationService.handler(APPLICATION_STARTED)
    ...
    static class AppLogInitDoneTransition implements
        ...
        @Override
        public void transition(ApplicationImpl app, ApplicationEvent event) {
            // 调用 LocalizationEventHandlerWrapper.handle(INIT_APPLICATION_RESOURCES)
            app.dispatcher.getEventHandler().handle(
    ...
    static class AppInitDoneTransition implements
        ...
        public void transition(ApplicationImpl app, ApplicationEvent event) {
            ...
            for (Container container : app.containers.values()) {
                // 调用 ContainerEventDispatcher.handle(ContainerEventType.INIT_CONTAINER)
                app.dispatcher.getEventHandler().handle(new ContainerInitEvent(
                        container.getContainerId()));
            }
        }
    ...
    public void handle(ApplicationEvent event) {
        // eventType = ApplicationEventType.INIT_APPLICATION
        // eventType = ApplicationEventType.APPLICATION_LOG_HANDLING_INITED
        // eventType = ApplicationEventType.APPLICATION_INITED
        this.writeLock.lock();
        ...
        try {
            ...
            try {
                ...
                // 调用 AppInitTransition.doTransition(INIT_APPLICATION)
                // 调用 AppLogInitDoneTransition.doTransition(APPLICATION_LOG_HANDLING_INITED)
                // 调用 AppInitDoneTransition.doTransition(APPLICATION_INITED)
