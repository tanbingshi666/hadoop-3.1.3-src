...
public class RMAppAttemptImpl implements RMAppAttempt, Recoverable {
    ...
    public void handle(RMAppAttemptEvent event) {
        ...
        try {
            ...
            try {
                ...
                // (NEW -> START) 调用 AttemptStartedTransition.doTransition()
                // (SUBMITTED -> ATTEMPT_ADDED) 调用 ScheduleTransition.doTransition() -> RMAppAttemptState.SCHEDULED;
                // (SCHEDULED -> CONTAINER_ALLOCATED) 调用 AMContainerAllocatedTransition.doTransition() -> RMAppAttemptState.ALLOCATED_SAVING
                // (ALLOCATED_SAVING => ALLOCATED) 调用 AttemptStoredTransition.doTransition()
    ...
    private static final class AttemptStartedTransition extends BaseTransition {
        ...
        public void transition(RMAppAttemptImpl appAttempt,
            ...
            // 往 ApplicationMasterService 注册 ApplicationAttemptId
            ...
            // event = AppAttemptAddedSchedulerEvent
            // eventType = SchedulerEventType.APP_ATTEMPT_ADDED
            // 调用 EventDispatcher.handler() 也即 CapacityScheduler.handler()
    ...
    public static final class ScheduleTransition
        ...
        public RMAppAttemptState transition(RMAppAttemptImpl appAttempt,
            ...
            if (!subCtx.getUnmanagedAM()) {
                ...
                // AM 黑名单对应的 NodeManager
                ResourceBlacklistRequest amBlacklist =
                        appAttempt.getAMBlacklistManager()
                                .getBlacklistUpdates();
                if (LOG.isDebugEnabled()) {
    ...
    private void launchAttempt() {
        ...
        // 调用 ApplicationMasterLauncher.handle()
