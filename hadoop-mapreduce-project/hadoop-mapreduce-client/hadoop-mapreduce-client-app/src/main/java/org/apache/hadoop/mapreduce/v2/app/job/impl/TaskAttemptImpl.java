...
public abstract class TaskAttemptImpl implements
    ...
    public void handle(TaskAttemptEvent event) {
        ...
        try {
            ...
            try {
                // 调用 RequestContainerTransition.doTransition(TaskAttemptEventType.TA_SCHEDULE)
                // 调用 ContainerAssignedTransition.doTransition(TaskAttemptEventType.TA_ASSIGNED)
    ...
    private static TaskAttemptUnsuccessfulCompletionEvent
    ...
    static class RequestContainerTransition implements
        ...
        public void transition(TaskAttemptImpl taskAttempt,
            ...
            if (rescheduled) {
                ...
                // 申请容器事件
                // 调用 ContainerAllocatorRouter.handle(ContainerAllocator.EventType.CONTAINER_REQ)
