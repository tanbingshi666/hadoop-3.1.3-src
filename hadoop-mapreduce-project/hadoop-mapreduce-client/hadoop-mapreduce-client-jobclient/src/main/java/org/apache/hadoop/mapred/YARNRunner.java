...
public class YARNRunner implements ClientProtocol {
    ...
    private ContainerLaunchContext setupContainerLaunchContextForAM(
        ...
        // 在 environment 设置 CLASSPATH (比如添加 hadoop jar、任务 jar、启动 AM 命令等)
        ...
        // 将启动 AM 容器命令以及相关配置信息封装成 ContainerLaunchContext
    ...
    private List<ResourceRequest> generateResourceRequests() throws IOException {
        ...
        // 根据系统配置 (yarn-site.xml) 获取前缀为 yarn.app.mapreduce.am.resource. 对应的值
        // 默认返回空
        List<ResourceInformation> resourceRequests = ResourceUtils
                .getRequestedResourcesFromConfig(conf,
