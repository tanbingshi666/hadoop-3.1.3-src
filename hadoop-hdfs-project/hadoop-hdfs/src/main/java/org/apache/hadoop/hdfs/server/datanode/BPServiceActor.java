...
class BPServiceActor implements Runnable {
    ...
    private void connectToNNAndHandshake() throws IOException {
        // get NN proxy
        // 创建 DatanodeProtocolClientSideTranslatorPB (通讯协议接口为 DatanodeProtocol) 并获取 NameNode 代理
    ...
    void register(NamespaceInfo nsInfo) throws IOException {
        ...
        // (Datanode Uuid 01263ed0-7bb5-4dec-845b-97a8d2d5d052) service to hj101/192.168.2.101:53310 beginning handshake with NN
    ...
    public void run() {
        ...
        try {
            while (true) {
                ...
                try {
                    // setup storage
                    // DataNode 连接 NameNode 并向 NameNode 注册 DataNode 信息
