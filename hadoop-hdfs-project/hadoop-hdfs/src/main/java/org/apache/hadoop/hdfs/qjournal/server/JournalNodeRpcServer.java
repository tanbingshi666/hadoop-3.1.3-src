...
public class JournalNodeRpcServer implements QJournalProtocol,
    ...
    JournalNodeRpcServer(Configuration conf, JournalNode jn) throws IOException {
        ...
        // 设置 Rpc Server 通讯协议 QJournalProtocolPB
        RPC.setProtocolEngine(confCopy, QJournalProtocolPB.class,
                ProtobufRpcEngine.class);
        // 创建 QJournalProtocolPB 协议接口的实现类对象
        ...
        // 添加 JournalNodeRpcServer 内部的通讯协议 InterQJournalProtocolPB ( JournalNode 与 JournalNode 之间交互)
