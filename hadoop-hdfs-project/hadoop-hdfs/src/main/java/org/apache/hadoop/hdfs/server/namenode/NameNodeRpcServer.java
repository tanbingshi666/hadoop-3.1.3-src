...
public class NameNodeRpcServer implements NamenodeProtocols {
    ...
    public NameNodeRpcServer(Configuration conf, NameNode nn)
        ...
        // 默认返回 null (因为没有在 hdfs-site.xml 配置 key = dfs.namenode.servicerpc-address.mycluster.nn1 value = hj101:53310)
        ...
        // 默认返回 null 如果在 hdfs-site.xml 配置 dfs.namenode.lifeline.rpc-address.mycluster.nn1 = xxx
    ...
    public NamespaceInfo versionRequest() throws IOException {
        checkNNStartup();
        // DataNode 获取 NameNode 信息 返回 NamespaceInfo
