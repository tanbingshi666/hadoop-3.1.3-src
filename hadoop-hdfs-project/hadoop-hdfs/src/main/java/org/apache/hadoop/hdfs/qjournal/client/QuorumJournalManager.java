...
public class QuorumJournalManager implements JournalManager {
    ...
    static List<AsyncLogger> createLoggers(Configuration conf,
        ...
        // 解析 JournalNode 地址 也即解析 hj101:8485;hj102:8485;hj103:8485/mycluster
        // 1 -> hj101:8485
        // 2 -> hj102:8485
        // 3 -> hj103:8485
        ...
        for (InetSocketAddress addr : addrs) {
            ret.add(
                    // 创建 IPCLoggerChannel
                    factory.createLogger(conf, nsInfo, jid, nameServiceId, addr)
            );
        }
        return ret;
    }
    ...
    private void selectStreamingInputStreams(
        ...
        for (Map.Entry<AsyncLogger, RemoteEditLogManifest> e : resps.entrySet()) {
            ...
            for (RemoteEditLog remoteLog : manifest.getLogs()) {
                ...
                // 创建 HTTP 拉取 JournalNode EditLog 输入流 返回 EditLogFileInputStream
