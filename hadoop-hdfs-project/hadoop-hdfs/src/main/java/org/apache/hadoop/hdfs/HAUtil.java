...
public class HAUtil {
    ...
    public static boolean isHAEnabled(Configuration conf, String nsId) {
        // 获取 NameNode HA 的地址 比如如下：
        // mycluster —> [nn1->hj101:8020,nn2:hj102:8082]
    ...
    public static String getNameNodeId(Configuration conf, String nsId) {
        ...
        // 从配置文件判断当前节点是否启动 NameNode 如果是返回对应的值 比如如下
        // [mycluster,nn1]
        // [mycluster,nn2]
        String suffixes[] = DFSUtil.getSuffixIDs(
                conf, DFS_NAMENODE_RPC_ADDRESS_KEY,
                nsId, null,
