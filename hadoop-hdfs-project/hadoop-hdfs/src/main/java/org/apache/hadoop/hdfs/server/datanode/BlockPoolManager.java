        ...
        synchronized (this) {
            ...
            if (!toAdd.isEmpty()) {
                ...
                for (String nsToAdd : toAdd) {
                    ...
                    // 创建 BPOfferService
                    // 一个 BPOfferService 就是一个联邦 也即一个 NameNode HA 组合
                    // 比如一般配置 NameNode HA 的 nameservice 为 mycluster
                    // mycluster 也即 NameNode 的 HA 组合 存在两个 NameNode (nn1,nn2)
            ...
            // 启动 BPOfferServices 的 BPServiceActor 去跟 NameNode 进行连接并向 NameNode 注册
            startAll();
        }
